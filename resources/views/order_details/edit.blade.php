                            ...
                            <?php foreach($selected_services as $service_key => $service_value){?>
                                    ...
                                    <tbody>
                                        <?php foreach($selected_items as $item_key => $item_value){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control calc_num" value="<?php echo $item_value->pickup_qty?>" name="pickup_qty[<?php echo $service_value->service_id?>][]"  onchange="calc_value(<?php echo $service_value->service_id?>)"/>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <input type="number" step="any" required class="form-control" value="<?php echo $service_value->service_weight?>" name="weight[<?php echo $service_value->service_id?>]" />
                                        </td>
                                    </tr>
                               <tbody>
                            </table>
                        ...
                        html = '<table class="table" id="table'+$service_id+'">'+
                                ...
                                '<tbody>'+
                                    '<tr>'+
                                        ...
                                        '<td>'+
                                            '<input type="number" class="form-control calc_num" min="1" value="1" name="pickup_qty['+$service_id+'][]" onchange="calc_value('+$service_id+')"/>'+
                            ...
                            '<table id="table_summary'+$service_id+'" class="table">'+
                                '<tbody>'+
                                    '<tr>'+
                                        ...
                                        '</th>'+
                                        '<td width="25%">'+
                                            '<input type="number" step="any" class="form-control" value="0" min="0.1" required name="weight['+$service_id+']" />'+
                                        '</td>'+
                                    '</tr>'+
                               '<tbody>'+
                            '</table>'+
