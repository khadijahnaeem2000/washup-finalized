...
@include( '../sweet_script')
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                {!! Form::model($data, ['method' => 'PATCH','id'=>'form','enctype'=>'multipart/form-data','route' => ['rate_lists.update', $data->id]]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                {!! Html::decode(Form::label('service_id','Service <span class="text-danger">*</span>')) !!}
                                    {!! Form::select('service_id', $services,null, array('class' => 'form-control','onchange'=>'fetch_items(this.value)')) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('item_id', $items,null, array('class' => 'form-control','required')) !!}
    ...
    <script>
        ...
        $(document).ready(function(){
            // if we allow them to call functions then already selected data will not be shown.
