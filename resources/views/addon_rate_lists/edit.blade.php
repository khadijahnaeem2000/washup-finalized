    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                {!! Form::model($data, ['method' => 'PATCH','id'=>'form','enctype'=>'multipart/form-data','route' => ['addon_rate_lists.update', $data->id]]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('addon_id', $addons,null, array('class' => 'form-control')) !!}
