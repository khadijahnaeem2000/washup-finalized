    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                {!! Form::open(array('url' => 'rep_addon_rate_list','method'=>'POST','id'=>'form','enctype'=>'multipart/form-data')) !!}
                    ...
                    <div class="card-title">
                     ...
                     @can('rate_list-create')
                        <div class="card-toolbar">
                            <a  href="{{ route('addon_rate_lists.create') }}" class="btn btn-primary font-weight-bolder">
