        ...
        <div class="col-lg-12">
                 ...
                 <div class="card-header py-3">
                    ...
                    <div class="card-toolbar d-print-none" >
                        <div class="btn-group btn-group">
                            <a  href="{{ route('order_packs.index') }}" class="btn btn-primary btn-sm ">
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <label>Pickup Timeslot:</label>
                                <h4> {{$data->pickup_timeslot}}</h4>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
           ...
           @if($data->ref_order_id)
            <div class="card card-custom gutter-b example example-compact d-print-none">
                    ...
                    <div class="card-header py-3">
                    <div class="card-title">
                        <h3 class="card-label">HFQ Order History</h3>
                    </div>
                </div>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="table-responsive">
                                    <table class="table dt-responsive">
                                        ...
                                        @if($ref_histories)
                                            <tbody>
                                                @foreach($ref_histories as $value)
