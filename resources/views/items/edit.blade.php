                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                {{ Form::text('name', null, array('placeholder' => 'name','class' => 'form-control' ,'autofocus' => '', 'required','minlength'=>'3')) }}
                                @if ($errors->has('name')) 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="margin-top: 20px">
                                ...
                                <div class="image-input image-input-outline" id="kt_profile_avatar">
                                    @if($data->image)
                                        <img id="blah" src="{{ asset('uploads/items/'.$data->image) }}" class="image-input-wrapper" alt="your image"/></center>
                                    @else
