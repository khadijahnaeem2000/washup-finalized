                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2" style="margin-top: 20px">
                                <div class="image-input image-input-outline" id="kt_profile_avatar">
                                    @if($user->image)
                                        <img id="blah" src="{{ asset('uploads/users/'.$user->image) }}" class="image-input-wrapper" alt="your image"/></center>
                                    @else
                                        <img id="blah" src="{{ asset('uploads/users/no_image.png') }}" class="image-input-wrapper" alt="your image"/></center>
                                    @endif
                                    @if ($errors->has('image'))  
