        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">lodges Complaint</h3>
                ...
                <!--begin::Form-->
                {!! Form::model($data, ['method' => 'POST','id'=>'form','enctype'=>'multipart/form-data','route' => ['complaints.store']]) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('complaint_nature_id', ['' =>'--- Select Nature ---']+$complaint_natures,0, array('class'=> 'form-control','autofocus' => '' ,'onchange'=>'show_tags(this.value)')) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('complaint_tag_id',[''=>'--- Select Tag ---'],0, array('class'=> 'form-control')) !!}
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.data){
                        ...
                        $("#complaint_tag_id").html('<option>--- Select Tag ---</option>');
                    }
                }
            });
        }
