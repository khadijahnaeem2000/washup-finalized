    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                {!! Form::open(array('route' => 'orders.store','method'=>'POST','id'=>'form','enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('pickup_date', null, array( 'placeholder' => 'yyyy-mm-dd','class' => 'form-control dpicker','autocomplete'=>'off','onchange'=>'fn_delivery_date(this.value,3)')) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('pickup_address_id',[0=>'Please Select Address'],null, array('class'=> 'form-control','onchange'=>'get_lat_lng(this.value)')) !!}
        ...
        function calc_delivery_date(pickup_date,incre){
            ...
            if( temp.getDay() == 0) {
                ...
                disableSpecificDates.forEach(function(rec,index) {
                    console.log("rec: "+rec + ", date: " +test_date )
                    if(rec == test_date){
                       check = 1;
