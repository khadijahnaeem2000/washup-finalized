...
class PackingController extends Controller
{
    ...
    public function fn_find_packing_history($order_id, $status_id){
        ...
        //probably it is checking null entirely or probably it is just checking user_name is null or not                            
        ...
        if ($validator->passes()) {
            ...
            if(!($orders->isEmpty())){
                ...
                foreach ($orders as $key => $value) {
                    ...
                    $tag_hstry              = $this->fn_find_packing_history($value->id,8);
                    ...
                    //-------------------------------------------------------
                    if(($tag_hstry->created_at) != 0 ){
                        error_log(print_r($tag_hstry,true));
                       $tag_dt = date('d-m-Y', strtotime($tag_hstry->created_at));
                       $tag_tm = date('H:i:s', strtotime($tag_hstry->created_at));
